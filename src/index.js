...
var BtnLink2 = ({ props, link, label, color = "black" }) => {
  const colorMap = {
...
var HeroSection = () => {
  ...
  )), /* @__PURE__ */ snapp.create("article", null, /* @__PURE__ */ snapp.create("h1", { className: "text-4xl font-bold" }, "Hi, I'm kigemmanuel"), /* @__PURE__ */ snapp.create("div", null, /* @__PURE__ */ snapp.create("p", { className: "font-bold" }, "Software Engineer"), /* @__PURE__ */ snapp.create("p", { className: "mt-5 leading-5" }, "With a strong foundation in both frontend and backend development, I bring ideas to life through clean code and thoughtful design.", /* @__PURE__ */ snapp.create("br", null), /* @__PURE__ */ snapp.create("br", null), "Whether it\u2019s developing modern websites, creating custom frameworks, or automating workflows, I\u2019m passionate about crafting solutions that make a real impact.")))), /* @__PURE__ */ snapp.create("div", { className: "flex flex-wrap gap-4 mt-8  lg:mt-0" }, /* @__PURE__ */ snapp.create(BtnLink2, { link: "#Tech-stack", label: "Tech Stack", color: "blue" }, "View my stack"), /* @__PURE__ */ snapp.create(BtnLink2, { link: "", label: "Mail Address" }, "Contact me")), /* @__PURE__ */ snapp.create("div", { class: "flex gap-4 mt-8" }, /* @__PURE__ */ snapp.create(Github, { color: "white" }), /* @__PURE__ */ snapp.create(Facebook, { color: "blue" }), /* @__PURE__ */ snapp.create(Gmail, { color: "red" })));
};
...
var FeactureProjectContainerRight = () => {
  return /* @__PURE__ */ snapp.create("article", { className: "my-8 grid md:gap-4 md:grid-cols-2" }, /* @__PURE__ */ snapp.create("div", { className: "mbl:gap-y-4 mbl:rounded-xl mbl:backdrop-blur-lg mbl:px-5 mbl:py-8 mbl:bg-black/10 flex relative order-2 flex-col md:justify-between" }, /* @__PURE__ */ snapp.create("div", { className: "md:text-right" }, /* @__PURE__ */ snapp.create("h3", { className: "text-xs font-bold text-red-800" }, "Freature Project"), /* @__PURE__ */ snapp.create("h4", { className: "text-xl font-bold text-red-500" }, "Snapp Frmowrk")), /* @__PURE__ */ snapp.create("div", { className: "md:text-red-600 md:absolute md:inset-0 md:my-auto md:backdrop-blur-md md:border md:border-white/30 md:bg-blue-600/10 md:shadow-xl md:p-5 md:rounded-2xl md:translate-y-8 md:-translate-x-[15%] md:w-[120%] md:h-min" }, "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Esse explicabo exercitationem, consectetur mollitia veniam sapiente quia quae quidem fugiat ad adipisci soluta odio quibusdam harum eligendi tempore amet quam rerum?")), /* @__PURE__ */ snapp.create("div", { className: "mbl:hidden md:order-1" }, /* @__PURE__ */ snapp.create(
    "img",
    {
