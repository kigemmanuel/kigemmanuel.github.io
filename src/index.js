...
var X = ({ className }) => {
  return /* @__PURE__ */ snapp.create("a", { href: "https://x.com/kigemmanuel", "aria-label": "X Profile", target: "_blank", className: "w-10 h-10 bg-slate-700 rounded-lg flex items-center justify-center hover:bg-gray-800 transition-colors " + className }, /* @__PURE__ */ snapp.create("svg", { className: "w-5 h-5 text-white", fill: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ snapp.create("path", { d: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.627l-5.1-6.614L2.306 21.75H-.012l7.644-8.746L.424 2.25h6.679l4.881 6.236L18.244 2.25zM17.15 19.806h1.826L5.293 4.171H3.365L17.15 19.806z" })));
};
